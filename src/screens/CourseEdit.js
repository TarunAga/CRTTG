...
export default function CourseEdit() {
    ...
    useEffect(() => {
        ...
        async function fetchData() {
            try {
                ...
                const response1 = await fetch('http://localhost:5000/api/getCourseData', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json'
                    },
    ...
    const handleSubmit = async (e) => {
        ...
        const response = await fetch('http://localhost:5000/api/updatecourse', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
                    ...
                    <div className="weirdsettings">
                        <div className="wow" onChange={handleChange}>
                            ...
                            <label style={{ width: 'auto' }}>
                                <input type="radio" name="courseType" value="Program Course" checked={creds.courseType === 'Program Course'}/> Program Course&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            </label>
                            <label>
